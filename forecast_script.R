...
monthly <- revenue %>%
  ...
  mutate(AndelStreamere = AntalStreamere / SamletBestand * 100) %>%
...
# insert quote
quote_df <- read_csv("C:/Users/pech/Desktop/RProjects/ForecastAbo/forecasts/famous_quotes.csv") %>%
  sample_n(1)
